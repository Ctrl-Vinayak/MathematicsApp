...
import com.example.android.mathematicsapp.trainingmode.exerciseNum.ExerciseEight;

public class LevelSelectionExerciseEight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_selection_exercise_eight);
        ...
        for (int i = 0; i < 33; i++) {
            ...
            _buttonLevel[(i * 3)].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(LevelSelectionExerciseEight.this, ExerciseEight.class);
        ...
        _backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LevelSelectionExerciseEight.this, TrainingModeBeginScreen.class);
                startActivity(intent);
            }
        });
    }
