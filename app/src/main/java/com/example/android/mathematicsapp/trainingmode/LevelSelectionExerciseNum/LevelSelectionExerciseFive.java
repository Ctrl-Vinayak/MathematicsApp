...
public class LevelSelectionExerciseFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_selection_exercise_five);
        ...
        for (int i = 0; i < 33; i++) {
            ...
            _buttonLevel[(i * 3)].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(LevelSelectionExerciseFive.this, ExerciseFive.class);
        ...
        _backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LevelSelectionExerciseFive.this, TrainingModeBeginScreen.class);
                startActivity(intent);
            }
        });
    }
