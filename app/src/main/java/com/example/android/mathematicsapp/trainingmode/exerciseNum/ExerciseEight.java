...
public class ExerciseEight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_eight);
        ...
        actionbarTitle.setText(getApplicationContext().getString(R.string.associative_rule) + ". Level: " + levelNum + " / " + 100);
                ...
                butOne.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (userInput.equals(answer)) {
                            ...
                            tvCurQuestion.setText("Current Question: " + questionsDone + "/" + 10);
                            if (questionsDone == 10) {
                                Intent intent = new Intent(ExerciseEight.this, LevelSelectionExerciseEight.class);
    ...
    private void checkAnswer(int num1, int num2, int ranBracketsPlacement) {
        if (ranBracketsPlacement == 1) {
            answer = "" + (num2);
        } else if (ranBracketsPlacement == 2) {
            answer = "" + (num1);
