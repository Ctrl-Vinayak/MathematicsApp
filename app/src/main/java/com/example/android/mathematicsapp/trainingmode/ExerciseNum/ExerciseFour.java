...
public class ExerciseFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionbarTitle.setText(getApplicationContext().getString(R.string.making_a_difference_with_signed_numbers) + ". Level: " + levelNum + " / " + 100);
                ...
                butOne.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (userInput.equals(answer)) {
                            ...
                            tvCurQuestion.setText("Current Question: " + questionsDone + "/" + 10);
                            if (questionsDone == 10) {
                                Intent intent = new Intent(ExerciseFour.this, LevelSelectionExerciseFour.class);
