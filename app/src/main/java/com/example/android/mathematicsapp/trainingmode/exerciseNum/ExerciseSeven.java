...
public class ExerciseSeven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionbarTitle.setText(getApplicationContext().getString(R.string.distributive_property) + ". Level: " + levelNum + " / " + 100);
                ...
                butOne.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (userInput.equals(answer)) {
                            ...
                            tvCurQuestion.setText("Current Question: " + questionsDone + "/" + 10);
                            if (questionsDone == 10) {
                                Intent intent = new Intent(ExerciseSeven.this, LevelSelectionExerciseSeven.class);
    ...
    private String mathematicsQuestions(int levelNum) {
        ...
        if (levelNum >= 1 && levelNum <= 100) {
            ...
            checkAnswer(num1, num2, num3, ranPlusOrMinus);
    ...
    private void checkAnswer(int num1, int num2, int num3, int ranPlusOrMinus) {
        if (ranPlusOrMinus == 2) {
