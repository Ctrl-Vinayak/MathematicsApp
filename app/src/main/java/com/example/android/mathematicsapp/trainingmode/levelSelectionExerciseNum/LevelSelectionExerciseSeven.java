...
import com.example.android.mathematicsapp.trainingmode.exerciseNum.ExerciseSeven;

public class LevelSelectionExerciseSeven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_selection_exercise_seven);
        ...
        for (int i = 0; i < 33; i++) {
            ...
            _buttonLevel[(i * 3)].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(LevelSelectionExerciseSeven.this, ExerciseSeven.class);
        ...
        _backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LevelSelectionExerciseSeven.this, TrainingModeBeginScreen.class);
                startActivity(intent);
            }
        });
    }
