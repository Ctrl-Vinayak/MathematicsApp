...
public class ExerciseNine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_nine);
        ...
        actionbarTitle.setText(getApplicationContext().getString(R.string.solve_basic_equations) + ". Level: " + levelNum + " / " + 100);
                ...
                butOne.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (userInput.equals(answer)) {
                            ...
                            tvCurQuestion.setText("Current Question: " + questionsDone + "/" + 10);
                            if (questionsDone == 10) {
                                Intent intent = new Intent(ExerciseNine.this, LevelSelectionExerciseNine.class);
    ...
    private void checkAnswer(int defaultAnswer) {
